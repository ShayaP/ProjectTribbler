...
func CheckBackendRetryLogic(t *testing.T, client0 interfaces.ClientInterface, back0, back1, back2, back3, back4, back5 interfaces.BackendInterface) {
	ne := func(e error) {
		if e != nil {
			debug.PrintStack()
			t.Fatal(e)
